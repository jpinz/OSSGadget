...
public class ProjectManagerFactoryTests
{
    ...
    {
        _managerOverrides[NuGetProjectManager.Type] = directory => new NPMProjectManager(_httpClientFactory, null); // Override the default entry for nuget and set it as another NPMProjectManager.
